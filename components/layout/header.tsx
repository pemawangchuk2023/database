			...
			<div className='flex items-center gap-2'>
				...
				<DropdownMenu>
					<DropdownMenuTrigger asChild>
						<Button
							variant='ghost'
							size='icon'
							className='relative hover:bg-gray-100 dark:hover:bg-gray-800 rounded-xl transition-all'
						>
					...
					<DropdownMenuContent
						align='end'
						className='w-96 shadow-xl border-gray-200 dark:border-gray-700'
					>
				...
				<DropdownMenu>
					<DropdownMenuTrigger asChild>
						<Button
							variant='ghost'
							className='relative h-10 gap-2 px-2 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-xl transition-all'
						>
					...
					<DropdownMenuContent
						align='end'
						className='w-56 shadow-xl border-gray-200 dark:border-gray-700'
					>
						...
						<DropdownMenuItem asChild>
							<Link href='/settings?tab=activity' className='cursor-pointer'>
								Activity Log
							</Link>
						</DropdownMenuItem>
						<DropdownMenuSeparator />
