                    ...
                    <div className="flex h-16 items-center border-b border-gray-200 dark:border-gray-800 px-4 justify-between bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-gray-800 dark:to-gray-900">
                        {!collapsed && (
                            <Link href="/dashboard" className="flex items-center gap-3 group">
                                ...
                                <div>
                                    <h1 className="text-base font-bold text-gray-900 dark:text-white">DocuVault</h1>
                                    <p className="text-[18px] text-gray-600 dark:text-gray-400">Ministry of Finance</p>
                                </div>
                            </Link>
                        )}
                        {collapsed && (
                            ...
                            if (collapsed) {
                                return (
                                    <Tooltip key={item.name}>
                                        ...
                                        <TooltipContent side="right" className="font-medium bg-gray-900 dark:bg-gray-800 text-white border-gray-700">
                                            {item.name}
                                        </TooltipContent>
                                    </Tooltip>
                                );
