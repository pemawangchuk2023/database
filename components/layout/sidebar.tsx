            ...
            {!collapsed && (
              <Link href="/dashboard" className="flex items-center gap-3 group">
                ...
                <div>
                  ...
                  <p className="text-[18px] text-slate-700 dark:text-gray-400">
                    Ministry of Finance
                  </p>
                </div>
              </Link>
                ...
                <Link
                  ...
                  className={cn(
                    ...
                    isActive
                      ...
                      : "text-slate-700 dark:text-gray-300 hover:bg-gradient-to-r hover:from-blue-50 hover:to-indigo-50 dark:hover:from-blue-900/20 dark:hover:to-indigo-900/20 hover:text-blue-600 dark:hover:text-blue-400 hover:scale-102",
