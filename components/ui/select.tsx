...
function SelectItem({
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        "focus:bg-blue-50 dark:focus:bg-blue-950/30 focus:text-blue-900 dark:focus:text-blue-100 hover:bg-slate-100 dark:hover:bg-slate-800 relative flex w-full cursor-pointer items-center gap-2 rounded-sm py-2 pr-8 pl-2 text-sm outline-hidden select-none data-[disabled]:pointer-events-none data-[disabled]:opacity-50 transition-colors",
        className
      )}
      {...props}
    >
